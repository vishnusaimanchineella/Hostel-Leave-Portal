    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leavetype', models.CharField(choices=[('sick', 'Sick Leave'), ('casual', 'Casual Leave'), ('emergency', 'Emergency Leave'), ('study', 'Study Leave'), ('quarantine', 'Self Quarantine')], default='sick', max_length=25, null=True)),
